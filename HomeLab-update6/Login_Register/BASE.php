...
{
    $usera = array(
        "too short" => "Username atleast 6 characters long",
        "too long" => "Username less than 10 characters long",
        "letter num" => "Username must contain only letters and numbers",
        "no num start" => "Username not start with a number"
    );
    $passa = array(
        "too short" => "Password atleast 6 characters long",
        "too long" => "Password must be less than 10 characters long",
        "letter num" => "Password must contain only letters and numbers",
        "one lowercase" => "Password must have atleast one lowercase letter",
        "one uppercase" => "Password must have atleast one uppercase letter",
        "one num" => "Password must have atleast one number",
    );
    $msgs = array();

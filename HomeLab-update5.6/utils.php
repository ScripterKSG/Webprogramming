    ...
    function list_menu($premiums, $meals, $images)
    {
        ...
        */
        ...
        foreach ($meals as $meal => $href) {
            ...
            $list = <<<LIST
            $list
            <div style="text-align:center;border: 2px solid black;background-color: #7c98b3">
            <img style="max-height: 500px;padding: 0;border: 2px solid #f9eae1;display: block;margin-left: auto;margin-right: auto" src=$foodImage alt="Missing image">

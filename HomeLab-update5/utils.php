...
class Page_stuff
{
    ...
    function list_menu($premiums, $meals)
    {
        /*
        ...
        */
        ...
        foreach ($meals as $meal => $href) {
            if (in_array($meal, $premiums)) {
                $list = $list . "<li>*<a href='" . $href . "'>" . $meal . "</a></li>";
            } else {
                $list = $list . "<li><a href='" . $href . "'>" . $meal . "</a></li>";
            }
        }
...
class Mechs
{
    ...
    function add_toBank($url, $user, $pass)
    {
    ...
    function get_fromBank($url)
    {
        /*
        get all colon dilimeted content from txt file. line by line.
        "$user : $pass"
        */
        $file = fopen($url, "r");
        $users = [];
        ...
        while (($line = fgets($file)) !== false) {
            ...
            $bank_line = explode(":", $line);
            array_push($users, $bank_line[0]);
            array_push($passes, $bank_line[1]);
        }
        fclose($file);
        return [$users, $passes];
    }
    ...
    */
    ...
    function __construct($object)
    {
        ...
        */
        ...
        $_SESSION['CookieSpanShort'] = 120; // seconds
        ...
        foreach ($foods as $meals) {
            foreach ($meals as $meal => $href) {
                ...
                if (in_array($meal, $premiums) && $base_ref == $file_) {
                    ...
                    if (!$_SESSION['logged']) {
                        // if not logged
                        echo "<script>alert('You need to register or log in to access this page');</script>";
...
$OBJECT = array(
    ...
    "image_food" => array(
        ...
        "SweetPotatoPancakes" => $recipeImages_ . "/SweetPotatoPancakes.jpg",
        //lunch ...
        "ChoppedSalad" => $recipeImages_ . "/ChoppedSalad.jpg",
        "TarragonChickenSalad" => $recipeImages_ . "/TarragonChickenSalad.jpg",
        //dinner ...
        "BakedAlfredoPasta" => $recipeImages_ . "/BakedAlfredoPasta.jpg",
        "BeefStroganoff" => $recipeImages_ . "/BeefStroganoff.jpg",
        "BlackEyedBeansRice" => $recipeImages_ . "/BlackEyedBeansRice.jpg",
        "Slumgullion" => $recipeImages_ . "/Slumgullion.jpg",
        //dessert ..
        "ChocolateCake" => $recipeImages_ . "/ChocolateCake.jpg",
        "VisitingCake" => $recipeImages_ . "/VisitingCake.jpg",
        //sides ..
        "FrenchBread" => $recipeImages_ . "/FrenchBread.jpg",
        "SandwichBread" => $recipeImages_ . "/SandwichBread.jpg",
    ),
    // Meta ....
    "title" => "HomeLab",

...
<body onload="Render()">
	...
	<div id="main">
		...
		<div id='content'>
			...
			<?php
			echo "<img src='" . $object['image_food']['Black Eyed Beans Rice'] . "' alt='Black eyed beans rice'>"
			?>
			<h1>New Years Black-eyed Peas and Rice</h1>
			<p><a href='https://www.homesicktexan.com/2021/12/chambersville-black-eyed-peas-and-rice.html'>Adapted from HomeSick Texan</a></p>

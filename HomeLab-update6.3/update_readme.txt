...
5.1 changes from 5:
	-bug fixes: login.php to register.php fixed
	-login and register form handling alerts will show now 
		(in update 5, alerts letting you know wether username existed in database or not in both register and login were supposed to pop up
		but didn't. So that's fixed)
	-some documentation written...not fully done..or barely much written tbh, lol, under continuous improvement

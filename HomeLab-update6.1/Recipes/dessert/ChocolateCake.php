...
<body onload="Render()">
	...
	<div id="main">
		...
		<div id='content'>
			...
			<?php
			echo "<img src='" . $object['image_food']['Chocolate Cake'] . "' alt='French Chocolate Cake'>"
			?>
			<h1>Easy Chocolate Cake</h1>
			<p><a href='https://smile.amazon.com/Joy-Cooking-Fully-Revised-Updated/dp/1501169718/'>Adapted from Joy of Cooking</a></p>
